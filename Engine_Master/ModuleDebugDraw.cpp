...
public:
	...
	void drawPointList(const dd::DrawVertex * points, int count, bool depthEnabled) override
	{
		...
		glUniformMatrix4fv(linePointProgram_MvpMatrixLocation, 1, GL_FALSE, &mvpMatrix[0][0]);
...
{
	math::float4x4 view = camera->cam->viewMatrix;
	math::float4x4 proj = camera->cam->projectionMatrix;;
